...
{{--                                    <strong>{{ $message }}</strong>--}}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        @endphp
                        <select class="js-example-basic-multiple w-100" name="talent[]" multiple="multiple">
                    ...
                    <div class="form-group col-md-6">
                        <label for="social_link" class="col-form-label">{{ __('Social Link') }}<span
                                class="text-danger">*</span></label>
                        <textarea rows="3" id="social_link" rows="1"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            ...
                            <select class="js-example-basic-multiple w-100" name="country_visited[]"
                                    multiple="multiple">
